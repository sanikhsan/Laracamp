                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="item-bootcamp">
                            <img src="{{asset('landing/images/item_bootcamp.png')}}" alt="" class="cover">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('customer.checkout.store', $Camp->id)}}" class="basic-form" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="form-label">Full Name</label>
                                <input name="name" type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" value="{{Auth::user()->name}}" readonly  />
                                @if ($errors->has('name'))
                            ...
                            <div class="mb-4">
                                ...
                                <input name="email" type="email" class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" value="{{Auth::user()->email}}" readonly  />
                                @if ($errors->has('email'))
                            ...
                            <div class="mb-4">
                                ...
                                <input name="discount_code" type="text" class="form-control {{$errors->has('discount_code') ? 'is-invalid' : ''}}" value="{{ old('discount_code')}}" />
                            ...
                            {{-- <div class="mb-4">
                                ...
                                <input name="card_number" type="number" class="form-control {{$errors->has('card_number') ? 'is-invalid' : ''}}" maxlength="24" value="{{ old('card_number') ?: '' }}" required />
                            ...
                            <p class="text-center subheader mt-4">
                                <img src="{{asset('landing/images/ic_secure.svg')}}" alt=""> Your payment is secure and encrypted.
                            </p>
                        </form>
                    </div>
                </div>
