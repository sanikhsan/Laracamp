        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-600 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100"> 
                    ...
                    <h2 class="text-3xl font-extrabold dark:text-white mb-5">Editing Discount: {{$discount->name}}</h2>
                    <form action="{{route('admin.discount.update', $discount->id)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mt-3">
                            <input type="hidden" name="id" class="text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{old('name') ?: $discount->id}}" readonly required>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" name="code" class="text-sm rounded-lg block w-full p-2.5 {{$errors->has('code') ? 'text-red-900 dark:bg-red-100 dark:border-red-400 placeholder-red-700' : 'dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'}}" placeholder="Example: PROMO | Max: 5 words" value="{{old('code') ?: $discount->code}}" required>
                        </div>
                        @if ($errors->has('code'))
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="description" rows="2" class="block p-2.5 w-full text-sm rounded-lg border {{$errors->has('description') ? 'text-red-900 dark:bg-red-100 dark:border-red-400 placeholder-red-700' : 'dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'}}" placeholder="Example: Diskon untuk menyambut bulan suci Ramadhan">{{old('description') ?: $discount->description}}</textarea>
                        </div>
